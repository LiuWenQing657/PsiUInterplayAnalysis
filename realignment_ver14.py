...
if __name__ == "__main__":
    ...
    for i in range(len(sys.argv)):
        ...
        if input_para == '-i':
            ...
            print('Usage:')
            print('    python realignment_ver11.py [Options]* -x <reference> {-i <bam_in>} [-o <bam_out> -f <bam_fil_out>]')
            print('')
    ...
    if rm_multi_switch == 'on':
        ...
        remove_multi_mapping_ver4.remove_mp(output_bam_file_temp_all_sort, output_bam_file, rm_multi_mode)
